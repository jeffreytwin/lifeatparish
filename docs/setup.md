...
Edit `src/assets/js/modules/analytics.js` if you want to use your own Firebase project for analytics.
...
- [ ] Firebase Analytics key restricted to domain (in Google Cloud Console)
